//npm: status-code-enum. (2019, February 20). Npm. https://www.npmjs.com/package/status-code-enum

const statusCode = {};
statusCode.init = function () {
    /**
     * The server cannot or will not process the request due to an apparent
     * client error (e.g., malformed request syntax, size too large, invalid
     * request message framing, or deceptive request routing).
     */
    this.ClientErrorBadRequest = 400
     ...
     * updates.
     */
    this.ClientErrorConflict = 409
    /**
     * The server cannot meet the requirements of the Expect request-header
     * field.
     */
    this.ClientErrorExpectationFailed = 417
    /**
     * The request failed due to failure of a previous request (e.g., a
     * PROPPATCH).
     */
    this.ClientErrorFailedDependency = 424
    /**
     ...
     */
    this.ClientErrorImATeapot = 418
    /**
     * The request did not specify the length of its content, which is required
     * by the requested resource.
     */
    this.ClientErrorLengthRequired = 411
    /**
     * The resource that is being accessed is locked.
     */
    this.ClientErrorLocked = 423
    /**
     * The client's session has expired and must log in again.
     */
    this.ClientErrorLoginTimeOut = 440
    /**
     ...
     */
    this.ClientErrorPaymentRequired = 402
    /**
     * The server does not meet one of the preconditions that the requester put
     * on the request.
     */
    this.ClientErrorPreconditionFailed = 412
    /**
     ...
     */
    this.ClientErrorPreconditionRequired = 428
    /**
     * The client must first authenticate itself with the proxy.
     */
    this.ClientErrorProxyAuthRequired = 407
    /**
     ...
     */
    this.ClientErrorRangeNotSatisfiable = 416
    /**
     ...
     * large.
     */
    this.ClientErrorRequestHeaderFieldsTooLarge = 431
    /**
     ...
     */
    this.ClientErrorUnauthorized = 401
    /**
     ...
     */
    this.ClientErrorUnavailableForLegalReasons = 451
    /**
     * The request was well-formed but was unable to be followed due to semantic
     * errors.
     */
    this.ClientErrorUnprocessableEntity = 422
    /**
     ...
     */
    this.ClientErrorURITooLong = 414
    /**
     ...
     */
    this.RedirectFound = 302
    /**
     * This and all future requests should be directed to the given URI.
     */
    this.RedirectMovedPermanently = 301
    /**
     ...
     * disambiguation.
     */
    this.RedirectMultipleChoices = 300
    /**
     ...
     */
    this.RedirectUseProxy = 305
    /**
     * The server was acting as a gateway or proxy and received an invalid
     * response from the upstream server.
     */
    this.ServerErrorBadGateway = 502
    /**
     ...
     */
    this.ServerErrorBandwidthLimitExceeded = 509
    /**
     * The server was acting as a gateway or proxy and did not receive a timely
     * response from the upstream server.
     */
    this.ServerErrorGatewayTimeout = 504
    /**
     * The server does not support the HTTP protocol version used in the
     * request.
     */
    this.ServerErrorHTTPVersionNotSupported = 505
    /**
     * The server is unable to store the representation needed to complete the
     * request.
     */
    this.ServerErrorInsufficientStorage = 507
    /**
     * A generic error message, given when an unexpected condition was
     * encountered and no more specific message is suitable.
     */
    this.ServerErrorInternal = 500
    /**
     * The server detected an infinite loop while processing the request (sent
     * in lieu of `208 Already Reported`).
     */
    this.ServerErrorLoopDetected = 508
    /**
    ...
    ServerErrorNetworkAuthRequired = 511,
         ...
         * it.
         */
        this.ServerErrorNotExtended = 510
    /**
     * The server either does not recognize the request method, or it lacks the
     * ability to fulfil the request. Usually this implies future availability
     * (e.g., a new feature of a web-service API).
     */
    this.ServerErrorNotImplemented = 501
    /**
     * The server is currently unavailable (because it is overloaded or down for
     * maintenance). Generally, this is a temporary state.
     */
    this.ServerErrorServiceUnavailable = 503
    /**
     * Transparent content negotiation for the request results in a circular
     * reference.
     */
    this.ServerErrorVariantAlsoNegotiates = 506
    /**
     ...
     * origin's response.
     */
    this.SuccessNonAuthoritativeInfo = 203
    /**
     ...
     */
    this.SuccessPartialContent = 206
    /**
